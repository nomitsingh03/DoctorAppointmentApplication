...
class OnlineAppointment
{
	...
	void dataAdd()		//method for creating Default docotr list present in the database.
	{
		...
		doctorMobileNumber.add(2345678891L);
		doctorMobileNumber.add(2345678901L);
		doctorMobileNumber.add(1234567890L);
		doctorMobileNumber.add(3456789012L);
		doctorMobileNumber.add(1230987654L);
		doctorMobileNumber.add(1235678904L);
			...
			long mno;
				...
				else 
				{
					...
					if(flag1==true)
					{
								...
								doctorPassword.add(sc.next());
								System.out.println("Registration is Successfull.");
								System.out.println("Details: Name: "+doctorName.get(doctorName.size()-1)+" number:"+doctorMobileNumber.get(doctorMobileNumber.size()-1));
								Thread.sleep(900);
...
//					break;
	...
	{
		OnlineAppointment ap=new OnlineAppointment();
		Scanner sc=new Scanner(System.in);
		ap.dataAdd();
		boolean flag=true;
		while(flag=true)
